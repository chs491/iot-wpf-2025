...
namespace WpfBasicApp02.ViewModels
{
    public class MainViewModel : Conductor<object>
    {
        ...
        public IObservableCollection<KeyValuePair<string, string>> Divisions { get; set; }

        public IObservableCollection<Book> Books { get; set; }
        ...
        private void LoadControlFromDb()
        {
            ...
            //Divisions = divisions;
            Divisions = (IObservableCollection<KeyValuePair<string, string>>)divisions;
        ...
        private void LoadGridFromDb()
        {
            ...
            //Books = books;
            Books = (IObservableCollection<Book>)books;
